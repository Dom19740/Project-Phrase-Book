 ...
 * auto-backup and the homescreen widget, neither of which a browser tab (or a bare "Add to Home
...
/** True once the page is already running as an installed homescreen app rather than a browser tab.
